...
Feature: 002_MPP_API_Proxy Amendment for individual account
@Proxy_Amendment
Scenario Outline: 002_MPP_API_Proxy Amendment
#########################  Encryption ##################################################
