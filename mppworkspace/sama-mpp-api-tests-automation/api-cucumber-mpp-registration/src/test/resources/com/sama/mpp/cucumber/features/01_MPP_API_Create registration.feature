...
Feature: 01_MPP_API_Create Registration
@01_01_Create_IndividualRegistration
Scenario Outline: 01_01_MPP_API_Create registration with single proxy for individual account
#########################  Encryption ##################################################
...
Scenario Outline: 01_02_MPP_API_Create registration with single proxy for business User Account
#########################  Encryption ##################################################
Given a REST API request "<requestFile>" and url "<encyptionEndpoint>" along with below headers under "%ENV%" environment
#----------------------------------------------------------------------------------------
#  | Headers         |                          Value                                   |
...
#| request.json  | /sp/dev/dummy/encrypt  | https://10.158.239.131/sp/dev/v1/token/generation |   https://10.158.244.98/sp/dev/dummy/decrypt |    200    | application/json |   application/json |9d62bf35-e1a5-4871-9ba9-bc288f82f33a|  rH3kO2eE2fW2kW5tC5nJ4tW1bU3eC1nD7xA0jX8fY6rJ0kQ1rE   |    %NOTEMPTY%      | Bearer   | %NOTEMPTY% | 3600   | %NOTEMPTY% | ips |
@01_03_Create_InvalidStructure
Scenario Outline: 01_03_MPP_API_Creation of Registration when request structure is not valid
#########################  Encryption ##################################################
Given a REST API request "<requestFile>" and url "<encyptionEndpoint>" along with below headers under "%ENV%" environment
#----------------------------------------------------------------------------------------
#  | Headers         |                          Value                                   |
...
################################################### The End ############################################
######################################################################################
@01_04_Create_BusinessAndIndividual
Scenario Outline: 01_04_MPP_API_Creation of Registration when request is for both Business and Individual
#########################  Encryption ##################################################
Given a REST API request "<requestFile>" and url "<encyptionEndpoint>" along with below headers under "%ENV%" environment
#----------------------------------------------------------------------------------------
#  | Headers         |                          Value                                   |
...
###########################################################################################
  Examples:
|   requestFile      |    signatureRequestFile    |  encyptionEndpoint     |       tokenEndpoint         |  decyptionEndpoint      |    signatureEndpoint   |              registrationEndpoint                     |statusCode| statusCode1 |     accept       |   content type     |   x_ibm_client_id                  |                   x_ibm_client_secret                 |   Encrypted_Text   |token_type|access_token|expires_in|consented_on|scope|autorization | signature  | participant-code    | Registration_Id  | ReasonCode |                                     Description |
| requestEncryption  |   01_04_generateSignature  | /sp/dev/dummy/encrypt  | /sp/dev/v1/token/generation |  /sp/dev/dummy/decrypt  | /sp/dev/dummy/generate | /sp/sit/v1/customer-proxy-registrations/registrations |  200     |  400        |application/json |   application/json |02a18293-3e8b-4b90-9456-4cb291734386|  W6pR1aA0gX4aM2gC4aT5yU6xI8pV7nL3aM1pU8aL7oQ3cN7uC4   |    %NOTEMPTY%      | Bearer   | %NOTEMPTY% | 3600     | %NOTEMPTY% | ips | %RUNTIME%   | %RUNTIME%  |  SANCBK              |  %RUNTIME%	      |   908      |    The registration cannot have an account holder of person and business      |
...
############################################################################################
@01_06_CreateReg_NotSupportedAccType
Scenario Outline: 01_06_MPP_API_Creation of Registration when Account Name match with the existing registration
#########################  Encryption ##################################################
Given a REST API request "<requestFile>" and url "<encyptionEndpoint>" along with below headers under "%ENV%" environment
#----------------------------------------------------------------------------------------
#  | Headers         |                          Value                                   |
...
###########################################################################################
  Examples:
|   requestFile      |    signatureRequestFile    |  encyptionEndpoint     |       tokenEndpoint         |  decyptionEndpoint      |    signatureEndpoint   |              registrationEndpoint                     |statusCode| statusCode1 |statusCode2 |     accept       |   content type     |   x_ibm_client_id                  |                   x_ibm_client_secret                 |   Encrypted_Text   |token_type|access_token|expires_in|consented_on|scope|autorization | signature  | participant-code | ReasonCode |          Description         |
| requestEncryption  |   01_07_generateSignature  | /sp/dev/dummy/encrypt  | /sp/dev/v1/token/generation |  /sp/dev/dummy/decrypt  | /sp/dev/dummy/generate | /sp/sit/v1/customer-proxy-registrations/registrations |  200     |  400        |    204     |application/json |   application/json |02a18293-3e8b-4b90-9456-4cb291734386|  W6pR1aA0gX4aM2gC4aT5yU6xI8pV7nL3aM1pU8aL7oQ3cN7uC4   |    %NOTEMPTY%      | Bearer   | %NOTEMPTY% | 3600     | %NOTEMPTY% | ips | %RUNTIME%   | %RUNTIME%  |  SANCBK           |   944      |    Maximum permitted number of proxies already linked to specified account |
############################################################################################
@01_08_CreateReg_NotSupportedProxyType
Scenario Outline: 01_08_MPP_API_Creation of Registration when proxy type is not supported by participant
#########################  Encryption ##################################################
Given a REST API request "<requestFile>" and url "<encyptionEndpoint>" along with below headers under "%ENV%" environment
#----------------------------------------------------------------------------------------
#  | Headers         |                          Value                                   |
